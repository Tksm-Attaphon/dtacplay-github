...
-(void)updateContent{
    ...
    switch (article.subCateID) {
        case SPORT_NEWS:
            url = [NSString stringWithFormat: @"%@sportnews/%@?m=share",DOMAIN_WEBSITE,article.contentID];
            break;
        case SPORT_THAI_FOOTBALL:
            url = [NSString stringWithFormat: @"%@sport/%@?m=share",DOMAIN_WEBSITE,article.contentID];
            break;
    ...
    if(article.feedID == nil){
        ...
        //                break;
        //        }
        //supporter = [Manager returnSupporter:[article.feedID intValue]];
