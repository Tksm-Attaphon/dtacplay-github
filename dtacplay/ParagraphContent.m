...
#import "DtacImage.h"
#import "Manager.h"
@implementation ParagraphContent
- (instancetype)initWithDictionary:(NSDictionary*)dictionary {
    if(self = [super init]){
        self.descriptionContent = [self isNSNull:[dictionary objectForKey:@"description"]];
        
        self.descriptionContent = [self.descriptionContent stringByReplacingOccurrencesOfString:@"strong>"
                                                   withString:@"b>"];
        ...
        self.descriptionContent = [Manager readableHTMLEntity:self.descriptionContent];
    }
    return self;
}
